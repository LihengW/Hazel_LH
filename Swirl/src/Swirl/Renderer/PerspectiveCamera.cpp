...
Swirl::PerspectiveCamera::PerspectiveCamera(float fov, float aspect, float neardistance, float fardistance)
...
void Swirl::PerspectiveCamera::RecaiculateViewMatrix()
{
...
void Swirl::PerspectiveCamera::SetProjection(float fov, float aspect, float neardistance, float fardistance)
{
